...
public class Tiles : MonoBehaviour
{
    ...
    public void ColorSet()
    {
        ...
        {
            GameObject.Find("Game_Master").GetComponent<Game_Master>().WrongText.enabled = true;
            StartCoroutine(No(2f));
    ...
    private IEnumerator No(float WaitTime)
    {

        yield return new WaitForSeconds(WaitTime);
        GameObject.Find("Game_Master").GetComponent<Game_Master>().WrongText.enabled = false;
